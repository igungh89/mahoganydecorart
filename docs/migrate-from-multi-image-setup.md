...
create-site:
  ...
  command:
    - >
      ...
      bench new-site frontend --no-mariadb-socket --admin-password=${ADMIN_PASSWORD} --db-root-password=${DB_PASSWORD} --install-app payments --install-app erpnext --set-default;
